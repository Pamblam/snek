...
function showGame(){
	...
	document.addEventListener('keydown', function(e){
		...
		switch(key){
			case 38: snek.changeDir('U'); e.preventDefault(); break;
			case 39: snek.changeDir('R'); e.preventDefault(); break;
			case 40: snek.changeDir('D'); e.preventDefault(); break;
			case 37: snek.changeDir('L'); e.preventDefault(); break;
...
function setCanvasSizeOpts(){
	...
	var availableHeight = innerHeight - canvas.getBoundingClientRect().top; console.log("ah", availableHeight);
	var opts = {
		"400/400":"400x400",
		"480/720":"480x720",
		"600/600":"600x600",
...
function resizeCanvas(){
	scrollTo(0,0);
	var w,h;
	var availableHeight = innerHeight - canvas.getBoundingClientRect().top; console.log(availableHeight);
